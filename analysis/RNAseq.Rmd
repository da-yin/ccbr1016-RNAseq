...
#### PCA
```{r PCA, fig.width=8, fig.height=7}
normalized_data_dir = "~/Desktop/active_projects/ccbr1016-RNAseq/analysis/processedData/normalized/"
...
```{r Venn overlap, fig.align='center', fig.height=6, fig.width=12}
...
```{r serine family amino acid biosynthetic process, fig.width=9, fig.height=8}
...
```{r aminoacyl_tRNA_biosynthesis, fig.width=10, fig.height=9}
normalized_data_SH1_SCR_0.5 = subset(normalized_data, select=c(gene, SCR_0pt5mM_A,SCR_0pt5mM_B,SH1_0pt5mM_A,SH1_0pt5mM_B))
